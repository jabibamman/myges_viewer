...
class MyGesScraper:
    ...
    def get_students_directory(self):
        ...
        write_to_json({"students": arr}, f'3AL2_2s.json', directory="directory")
        ...
        arr = du.get_students_info(self.driver)
        write_to_json({"students": arr}, f'3AL_2s.json', directory="directory")
        ...
        arr = du.get_students_info(self.driver)
        write_to_json({"students": arr}, f'3ESGI_2s.json', directory="directory")
        ...
        arr = du.get_students_info(self.driver)
        write_to_json({"students": arr}, f'4AL_1s.json', directory="directory")
        ...
        arr = du.get_students_info(self.driver)
        write_to_json({"students": arr}, f'4ESGI_1s.json', directory="directory")
        ...
        arr = du.get_students_info(self.driver)
        write_to_json({"students": arr}, f'3AL2_1s.json', directory="directory")
        ...
        arr = du.get_students_info(self.driver)
        write_to_json({"students": arr}, f'3AL_1s.json', directory="directory")
        ...
        arr = du.get_students_info(self.driver)
        write_to_json({"students": arr}, f'3ESGI_1s.json', directory="directory")
    ...
    def get_teachers_directory(self):
        ...
        write_to_json({"teachers": arr}, f'teacher-2022-2023.json', directory="directory")
